...
JNIEXPORT jstring JNICALL nativeImGetChoice(JNIEnv *env, jclass clazz, jint candidateId) {
    jstring retstr;
...
JNIEXPORT jint JNICALL nativeImGetPredictsNum(JNIEnv *env, jclass clazz, jstring fixed_str) {
