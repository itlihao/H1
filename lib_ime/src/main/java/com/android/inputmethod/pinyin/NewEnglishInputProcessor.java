...
public class NewEnglishInputProcessor {
    ...
    public boolean processKey(EditText inputContext, KeyEvent event, boolean upperCase, boolean realAction) {
        ...
        Editable editable = inputContext.getText();
        int start = inputContext.getSelectionStart();
