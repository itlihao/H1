 ...
 */
public class NewCandidateView extends View {
    /**
     ...
     * arrows.
     */
    private ArrowUpdaters mArrowUpdater;
    ...
    public NewCandidateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mActiveCellDrawable = ContextCompat.getDrawable(context, R.drawable.candidate_hl_bg);
        mSeparatorDrawable = ContextCompat.getDrawable(context, R.drawable.candidates_vertical_line);
        mCandidateMargin = r.getDimension(R.dimen.candidate_margin_left_right);

        mImeCandidateColor = ContextCompat.getColor(context, R.color.color_white);
        mRecommendedCandidateColor = ContextCompat.getColor(context, R.color.recommended_candidate_color);
        mNormalCandidateColor = mImeCandidateColor;
        mActiveCandidateColor = ContextCompat.getColor(context, R.color.color_white);
        ...
        mFootnotePaint.setColor(ContextCompat.getColor(context, R.color.footnote_color));
    ...
    public void initialize(Context context, ArrowUpdaters arrowUpdater,
    ...
    private void onSizeChanged() {
        ...
        if (mContentWidth == dip2px(846)) {
            mContentWidth -= dip2px(80);
        }
        mContentHeight = (int) ((getMeasuredHeight() - mPaddingTop - mPaddingBottom) * 0.75f);
        /**
...
//            mCandidatesPaint.setTextSize(30);
...
//        mSeparatorDrawable.draw(canvas);
    ...
    public boolean onTouchEventReal(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                clickedItemInPage = mapToItemInPage(x, y);
                if (clickedItemInPage >= 0) {
                    mTimer.startTimer(mPageNo, clickedItemInPage);
                }
                break;
    ...
    private class PressTimer extends Handler implements Runnable {
        ...
        public void startTimer(int pageNo, int activeInPage) {
            mTimer.removeTimer();
            mTimerPending = true;
