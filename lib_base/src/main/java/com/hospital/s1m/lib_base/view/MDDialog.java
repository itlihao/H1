...
public class MDDialog extends Dialog implements View.OnClickListener {
    ...
    private void initView() {
        ...
        TextView tvRNo = this.findViewById(R.id.tv_no);
        if (wrapper == null) {
            wrapper = new Wrapper();
        }
...
//        dismiss();
    ...
    public static class Builder {
        ...
        public Builder setRNo(String rno) {
            wrapper.rNo = rno;
            return this;
        }
        ...
        public Builder setshowRNo(boolean showRNo) {
            wrapper.showRNo = showRNo;
            return this;
        }
