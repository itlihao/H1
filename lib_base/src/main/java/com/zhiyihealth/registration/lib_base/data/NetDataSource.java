package com.zhiyihealth.registration.lib_base.data;
...
import com.zhiyihealth.registration.lib_base.converter.ObjectConverter;
import com.zhiyihealth.registration.lib_base.entity.Body;
import com.zhiyihealth.registration.lib_base.entity.Header;
import com.zhiyihealth.registration.lib_base.entity.HttpResult;
import com.zhiyihealth.registration.lib_base.listener.MyDownloadListener;
...
public class NetDataSource {
     ...
     * 不需要opeCode就传0
     */
    public static <T> void post(Object tag, String url, ResponseListener<T> listener) {
        HttpParams httpParams = new HttpParams();
        ...
        body.setParam(hashMap);
        httpResult.setBody(body);
        httpResult.getHeader().setCurrentTime(System.currentTimeMillis());
        String param = JSON.toJSONString(httpResult, SerializerFeature.WriteMapNullValue);
        httpParams.put("detail", param);
        post(tag, url, param, listener);
    }
     ...
     * 不需要opeCode就传0
     */
    public static <T> void postChangeHeader(Header header, Object tag, String url, ResponseListener<T> listener) {
        HttpParams httpParams = new HttpParams();
        HttpResult httpResult = new HttpResult<>();
        httpResult.setHeader(header);
        Body body = new Body();
